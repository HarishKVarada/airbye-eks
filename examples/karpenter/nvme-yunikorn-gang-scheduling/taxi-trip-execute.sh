...
#     2/ Ensure <S3_BUCKET> is replaced in "nvme-storage-yunikorn-gang-scheduling.yaml" file
#     3/ Execute the shell script which creates the input data in your S3 bucket
#     4/ Run `kubectl apply -f nvme-storage-yunikorn-gang-scheduling.yaml` to trigger the Spark job
